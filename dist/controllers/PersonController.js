...
var PersonSchema_1 = __importDefault(require("../schemas/PersonSchema"));
var PersonController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, PersonSchema_1.default.create(req.body)];
                    case 1:
                        person = _a.sent();
    ...
    PersonController.prototype.find = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var person, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, PersonSchema_1.default.find(req.body)];
                    case 1:
                        person = _a.sent();
                        return [2 /*return*/, res.send({ person: person })];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, PersonSchema_1.default.findByIdAndDelete(req.params.id)];
                    case 1:
                        _a.sent();
